...
def maquina():
    ...
    """
    qtd_kit = 5  # Quantidade inicial de KitKats
    qtd_suflair = 5  # Quantidade inicial de Suflairs
    qtd_fini = 5  # Quantidade inicial de Fini Tubes
    qtd_bis = 5  # Quantidade inicial de Bis Xtra
    qtd_notas_20 = 5  # Quantidade inicial de notas de R$20,00
    qtd_notas_10 = 5  # Quantidade inicial de notas de R$10,00
    qtd_notas_5 = 5  # Quantidade inicial de notas de R$5,00
    qtd_notas_2 = 5  # Quantidade inicial de notas de R$2,00
    qtd_notas_1 = 5  # Quantidade inicial de notas de R$1,00
    qtd_notas_0_5 = 5  # Quantidade inicial de moedas de R$0,50
    faturamento = 0.00
    menu_inicial()
        ...
        if op >= 1 and op <= 6:
            if op == 1:
                if qtd_kit < 1:
                    ...
                    if valorIns == 0.5 or valorIns == 0.50:
                        qtd_notas_0_5 += 1
                        ...
                        perguntadoce(qtd_kit, qtd_suflair, qtd_fini, qtd_bis, qtd_notas_20, qtd_notas_10, qtd_notas_5, qtd_notas_2, qtd_notas_1, qtd_notas_0_5)
